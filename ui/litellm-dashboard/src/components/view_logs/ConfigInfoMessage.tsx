    ...
    <div className="bg-info/10 border border-info/20 rounded-lg p-4 flex items-start">
      ...
      <div>
        ...
        <p className="text-sm text-info mt-1">
          To view request and response details, enable prompt storage in your RAW configuration by adding the following
          to your <code className="bg-info/15 px-1 py-0.5 rounded-sm">proxy_config.yaml</code> file, or toggle the
