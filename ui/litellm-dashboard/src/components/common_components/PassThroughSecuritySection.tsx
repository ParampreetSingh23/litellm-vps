  ...
  return (
    <Card className="block p-6">
      ...
      <p className="mb-4 text-sm text-muted-foreground">
        When enabled, requests to this endpoint will require a valid RAW Virtual Key
      </p>
      {premiumUser ? (
        ...
        <div>
          ...
          <div className="rounded-lg border border-warning/20 bg-warning/10 p-3">
            <p className="text-sm text-warning">
              Setting authentication for pass-through endpoints is a RAW Enterprise feature.
            </p>
          </div>
        </div>
      )}
