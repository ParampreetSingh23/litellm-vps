  ...
  return (
    <div className="w-full h-full overflow-y-auto p-4">
      <KeyInfoHeader
        ...
        regenerateTooltip={
          !premiumUser ? "This is a RAW Enterprise feature, and requires a valid key to use." : undefined
        }
      />
                    ...
                    {needsLifetimeSpendBackfill(currentKeyData.spend, currentKeyData.total_spend) && (
                      <HoverCard>
                        ...
                        <HoverCardContent className="w-80">
                          Lifetime tracking started with RAW v1.103.0 on September 19, 2026 and was not backfilled, so
                          this key&apos;s lifetime spend only counts usage since that upgrade.
                        </HoverCardContent>
                      </HoverCard>
                    )}
                  </p>
