  ...
  return (
    <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
      <SummaryCard
        ...
        info="The sum of recorded savings in the three tiles beside it. Auto-router requests without an estimate are excluded. Its caching term is the RAW-injected share; caching supplied by clients or providers appears only in the caching tile's Total figure."
      />
      <SummaryCard
