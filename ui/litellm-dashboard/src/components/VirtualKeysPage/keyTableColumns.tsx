  ...
  },
  {
    ...
    header: () => (
      <InfoHeader
        ...
        tooltip="Cumulative spend across every budget period. Budget resets do not touch this value. Lifetime tracking started with RAW v1.103.0 on September 19, 2026, so keys created earlier only count spend since that upgrade."
      />
    ),
    size: 130,
    enableSorting: false,
