      ...
      >
        <div className="flex items-center gap-2 border-b border-border px-3 py-3">
          <span className="text-[15px] font-bold tracking-tight text-foreground">
            RAW <span className="text-xs font-medium text-muted-foreground">by Rabbitt</span>
          </span>
          {!disableBouncingIcon && (
            <span
              className="animate-bounce text-lg leading-none"
              style={{ animationDuration: "2s" }}
              title="Thanks for using RAW!"
              aria-hidden
            >
              🌴
            </span>
        ...
        <div className="py-1">
          ...
          {canUseLiteAdmin && (
            <div className="flex h-[38px] items-center justify-between gap-3 px-3">
              <span className="text-[13px] text-foreground">Hide RAW Assistant</span>
              <Switch
                size="sm"
                checked={disableLiteAdmin}
                onCheckedChange={setDisableLiteAdmin}
                aria-label="Toggle hide RAW Assistant"
              />
            </div>
          )}
        </div>
