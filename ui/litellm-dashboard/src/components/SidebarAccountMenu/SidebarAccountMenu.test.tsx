...
describe("SidebarAccountMenu", () => {
  ...
  it("should render the version badge without an external release notes link", async () => {
    const user = userEvent.setup();
    renderWithProviders(<SidebarAccountMenu onLogout={mockOnLogout} />);
  ...
  it("should show the bouncing icon by default", async () => {
    ...
    renderWithProviders(<SidebarAccountMenu onLogout={mockOnLogout} />);
    await openMenu(user);
    expect(screen.getByTitle("Thanks for using RAW!")).toBeInTheDocument();
  });
  ...
  it("should hide the bouncing icon when Hide Bouncing Icon is enabled", async () => {
    ...
    renderWithProviders(<SidebarAccountMenu onLogout={mockOnLogout} />);
    await openMenu(user);
    expect(screen.queryByTitle("Thanks for using RAW!")).not.toBeInTheDocument();
  });
