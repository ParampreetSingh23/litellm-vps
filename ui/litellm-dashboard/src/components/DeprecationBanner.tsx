    ...
    >
      ...
      <div className="min-w-0 flex-1">
        ...
        <p className="mt-1 break-words text-muted-foreground">
          {`${featureName} is one of several experimental features we're considering removing, potentially as early as ${DEPRECATION_TARGET_DATE}. This list is a draft and is not final. If you rely on this feature, please contact your administrator.`}
        </p>
      </div>
      <button
        type="button"
