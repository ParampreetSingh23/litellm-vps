...
import RawBrand from "@/components/common_components/RawBrand";
...
function SsoEnabledNotice() {
  ...
  return (
    <Alert variant="info" className="mt-4">
      <Info />
      <AlertTitle>
        Single Sign-On (SSO) is enabled. RAW no longer automatically redirects to the SSO login flow upon loading this
        page. To re-enable auto-redirect-to-SSO, set{" "}
          ...
          <CardContent>
            <div className="flex w-full flex-col gap-4">
              <div className="text-center">
                <RawBrand className="mx-auto h-14" />
              </div>
        ...
        <CardContent>
          <TooltipProvider>
            <div className="flex w-full flex-col gap-4">
              ...
              <div className="text-center">
                <h3 className="text-2xl font-semibold text-foreground">Login to RAW</h3>
                <p className="text-sm text-muted-foreground">
                  Welcome to RAW by Rabbitt. Sign in to access the admin console.
                </p>
              </div>
