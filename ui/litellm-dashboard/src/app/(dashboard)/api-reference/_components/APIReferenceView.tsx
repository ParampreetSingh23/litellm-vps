    ...
    <div className="grid grid-cols-1 gap-2 p-8 h-[80vh] w-full mt-2">
      <div className="mb-5">
        ...
        <p className="mt-2 mb-2 text-sm text-muted-foreground">
          RAW is OpenAI Compatible. This means your API Key works with the OpenAI SDK. Just replace the base_url to
          point to your RAW endpoint. Example Below{" "}
        </p>
...
client = openai.OpenAI(
    ...
    base_url="${base_url}" # RAW is OpenAI compatible
)
...
llm = AzureOpenAI(
    ...
    temperature=0.0,
    azure_endpoint="${base_url}", # RAW endpoint
