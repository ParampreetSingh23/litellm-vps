      ...
      <CardHeader className="gap-3">
        <div>
          ...
          <p className="mt-1 text-sm text-muted-foreground">
            Requests with recorded RAW injection or provider cache reads or writes. A cache hit alone does not establish
            RAW injection; older logs may not record it.
          </p>
          <p className="mt-1 text-sm text-muted-foreground">
        ...
        <Tabs value={filter} onValueChange={changeFilter}>
          <TabsList aria-label="Prompt caching request filters">
            ...
            <TabsTrigger value="injected">RAW injected</TabsTrigger>
              ...
              <Table aria-label="Prompt caching requests">
                <TableHeader>
                  <TableRow>
                    ...
                    <TableHead>RAW injection</TableHead>
