      ...
      <Card>
        ...
        <CardContent>
          <p className="mb-4 text-sm text-muted-foreground">
            Headroom is a native RAW guardrail that compresses your prompts before they reach the model, so you pay for
            fewer input tokens. The tokens it removes are priced and shown on the Usage tab as compression savings.
          </p>
            ...
            <form onSubmit={form.handleSubmit(handleAdd)} noValidate>
              <FieldGroup>
                ...
                <FormField
                  ...
                  label={labelWithHint(
                    "Headroom API base",
                    "Base URL of your Headroom compression service (RAW calls its /v1/compress endpoint)",
                  )}
              ...
              <div className="mt-6 mb-4 rounded-lg border border-warning/20 bg-warning/10 p-3">
                <p className="text-sm text-warning">
                  ...
                  team is a RAW Enterprise feature.
                </p>
              </div>
