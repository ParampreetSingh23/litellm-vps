...
const VERTEX_SEARCH_API_WITH_ENGINE_PLACEHOLDER = "Any identifier you'll use to reference this in RAW";
            ...
            <FieldGroup>
              ...
              {selectedProvider === "pg_vector" && (
                <Alert variant="info">
                  ...
                  <AlertDescription>
                    <p>RAW provides a server to connect to PG Vector. To use this provider:</p>
                    <ol style={{ marginLeft: "16px", marginTop: "8px", listStyleType: "decimal" }}>
                      <li>Deploy a pgvector-compatible vector store server</li>
              ...
              {selectedProvider === "valkey" && (
                <Alert variant="info">
                  ...
                  <AlertDescription>
                    <p>
                      RAW searches documents you have already stored in Valkey. It does not create the index or upload
                    ...
                    <p style={{ marginTop: "8px" }}>
                      When a query comes in, RAW converts it to an embedding with the model below and returns the
                  ...
                  <AlertDescription>
                    ...
                    <ol style={{ marginLeft: "16px", marginTop: "8px", listStyleType: "decimal" }}>
                      ...
                      <li>
                        ...
                        the Engine ID field. The Vector Store ID is still required as the RAW-side name for this record,
              ...
              <FormField
                ...
                label={labelWithHint(
                  "Vector Store Name",
                  "Custom name you want to give to the vector store, this name will be rendered on the RAW UI",
                )}
              >
