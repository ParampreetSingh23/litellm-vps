...
${formattedBody}
  ...
  return (
    <div className="p-2">
      ...
      <p className="text-sm text-muted-foreground">See how RAW transforms your request for the specified provider.</p>
      <div className="mt-4 grid grid-cols-1 gap-4 lg:grid-cols-2">
        {/* Original Request Panel */}
        <Card>
          <CardHeader>
            <CardTitle className="text-2xl font-bold">Original Request</CardTitle>
            <CardDescription>The request you would send to RAW /chat/completions endpoint.</CardDescription>
          </CardHeader>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>How RAW transforms your request for the specified provider.</CardDescription>
