    ...
    <div className="flex w-full flex-col gap-6">
      <div className="bg-linear-to-r from-success/15 to-success/5 p-6 rounded-lg border border-success/15">
        <div className="flex items-center gap-3 mb-3">
          ...
          <h4 className="mb-0 text-xl font-semibold text-success">RAW Proxy API Integration</h4>
        </div>
        <span className="text-success">
          Connect to RAW Proxy Responses API for seamless tool integration with multiple model providers
        </span>
      </div>
      ...
      <div className="flex w-full flex-col gap-6">
        <FeatureCard
          ...
          description="Configure your RAW Proxy Virtual Key for authentication"
        >
          <div className="flex w-full flex-col gap-4">
            <div>
              <span>Get your Virtual Key from your RAW Proxy dashboard or contact your administrator</span>
            </div>
        ...
        <FeatureCard
          ...
          description="Connection details for your RAW MCP server"
        >
        ...
        <FeatureCard
          ...
          description="Complete cURL example for using the RAW Proxy Responses API"
    ...
    <div className="flex w-full flex-col gap-6">
      <div className="bg-linear-to-r from-info/15 to-info/5 p-6 rounded-lg border border-info/15">
        ...
        <span className="text-info">
          Connect OpenAI Responses API to your RAW MCP server for seamless tool integration
        </span>
      </div>
    ...
    <div className="flex w-full flex-col gap-6">
      <div className="bg-linear-to-r from-purple-50 to-blue-50 p-6 rounded-lg border border-purple-100 dark:from-purple-950 dark:to-blue-950 dark:border-purple-900">
        ...
        <span className="text-purple-700 dark:text-purple-300">
          Use tools directly from Cursor IDE with RAW MCP. Enable your AI assistant to perform real-world tasks without
  ...
  const StreamableHTTPTab = () => (
    <div className="flex w-full flex-col gap-6">
      <div className="bg-linear-to-r from-success/15 to-success/5 p-6 rounded-lg border border-success/15">
        ...
        <span className="text-success">
          Connect to RAW MCP using HTTP transport. Compatible with any MCP client that supports HTTP streaming.
        </span>
      </div>
      ...
      <div className="flex w-full flex-col gap-6">
        <div>
          ...
          <p className="text-lg text-muted-foreground">
            Use tools directly from any MCP client with RAW MCP. Enable your AI assistant to perform real-world tasks
