...
describe("MCPServerEdit (true passthrough warning)", () => {
  ...
  it("warns that RAW auth is disabled for a true_passthrough server", async () => {
  ...
  it("does not warn for an oauth_delegate server", async () => {
    ...
    expect(screen.queryByText("True Passthrough disables RAW authentication for this server")).not.toBeInTheDocument();
  });
