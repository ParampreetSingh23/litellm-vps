    ...
    <div>
      ...
      <div className="mb-10">
        <div className="mb-1 flex items-center justify-between">
          <h2 className="m-0 text-xl font-semibold text-foreground">RAW Content Filter</h2>
          <span
        ...
        <p className="mt-1 mb-5 text-[13px] text-muted-foreground">
          Built-in guardrails powered by RAW. Zero latency, no external dependencies, no additional cost.
        </p>
