        ...
        <div className="space-y-4">
          ...
          <div className="border border-info/15 bg-info/10 rounded-lg p-3">
            <div className="flex items-center justify-between mb-2">
              <div className="flex items-center gap-1.5">
                ...
                <span className="text-xs font-semibold text-info">Forward RAW API Key</span>
              </div>
              <Toggle enabled={g.forwardKey} onToggle={onToggleForwardKey} disabled={!isAdmin} />
            </div>
            <p className="text-xs text-info leading-relaxed">
              When enabled, the caller&apos;s RAW API key is forwarded as an{" "}
          ...
          <div className="flex items-start gap-2 bg-muted border border-border rounded-lg p-3">
            ...
            <p className="text-xs text-muted-foreground leading-relaxed">
              ...
              next step in the pipeline. See the RAW Generic Guardrail API for configuration details.
            </p>
          </div>
        </div>
