    ...
    <HoverCard>
      ...
      <HoverCardContent align="start" className="w-80">
        <div className="flex flex-col gap-3">
          ...
          <div className="flex flex-col gap-0.5">
            <span className="text-xs text-muted-foreground">RAW Model Name</span>
            <span className="flex min-w-0 items-center gap-1.5">
              ...
              <button
                type="button"
                aria-label="Copy RAW model name"
                data-testid={`copy-litellm-model-name-${model.model_info.id}`}
                className="shrink-0 cursor-pointer text-muted-foreground hover:text-foreground"
                onClick={() => void copyToClipboard(litellmModelName, "RAW model name copied")}
              >
          ...
          <div className="flex flex-col gap-3">
            ...
            <div className="flex flex-col gap-1">
              ...
              <span className="text-xs text-muted-foreground">
                Credentials saved in RAW that can be added to models repeatedly.
              </span>
            </div>
            <div className="flex flex-col gap-1">
