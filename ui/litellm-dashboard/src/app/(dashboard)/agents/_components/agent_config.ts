  ...
  basic: {
    ...
    fields: [
      ...
      },
      {
        ...
        defaultValue: "1.0",
        tooltip:
          "The A2A protocol version RAW serves to clients for this agent. RAW converts the upstream agent's responses to this version, so clients always see the version you pick here regardless of the original agent's version.",
        helpText:
          "RAW serves this version to clients and converts the upstream agent's responses to match it, regardless of the original agent's version.",
      },
    ],
  },
  skills: {
