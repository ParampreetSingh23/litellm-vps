            ...
            {killSwitch ? (
              <>
                <p className="text-muted-foreground">
                  ...
                  everyone using the agent and cannot be undone from RAW
                </p>
        ...
        <DialogContent className="max-h-[calc(100dvh-2rem)] overflow-y-auto">
          ...
          <div className="space-y-4">
            <Alert variant="error">
              ...
              <AlertDescription>
                RAW will call {killSwitch?.method ?? "POST"} {killSwitch?.url} immediately. Whatever that webhook does
                to the agent is outside RAW&apos;s control and cannot be reverted here
              </AlertDescription>
            </Alert>
            <div>
