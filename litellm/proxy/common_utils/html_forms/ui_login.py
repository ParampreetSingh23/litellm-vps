...
def build_ui_login_form(
    ...
    info_box_html: Final = (
        ...
        <div class="info-box">
            ...
            <p>By default, Username is <code>admin</code> and Password is your configured <code>MASTER_KEY</code>.</p>
        </div>
        """
    )
...
<head>
    <meta charset="UTF-8">
    <title>Login - RAW by Rabbitt</title>
...
<body>
    <form action="{url_to_redirect_to}" method="post">
        ...
        <div class="logo-container">
            <div class="logo">
                RAW <span style="font-size:0.55em;font-weight:500;color:#64748b">by Rabbitt</span>
            </div>
        </div>
        <h2>Login to RAW</h2>
        <p class="subtitle">Welcome to RAW by Rabbitt. Sign in to access the admin console.</p>
        {info_box_html}
