...
def render_cli_sso_success_page() -> str:
    ...
    <head>
        <meta charset="UTF-8">
        <title>CLI Authentication Successful - RAW by Rabbitt</title>
    ...
    <body>
        <div class="container">
            ...
            <div class="success-box">
                ...
                <p>Your RAW CLI has been successfully authenticated and is ready to use.</p>
            </div>
            ...
            <div class="instructions">
                ...
                <p>You can now use RAW CLI commands with your authenticated session.</p>
            </div>
