...
<title>Authorize CLI access - RAW by Rabbitt</title>
<style>
body {{
...
<p>A command-line client at <code>{escape(client_origin)}</code> wants to call RAW as <strong>{escape(user_id)}</strong>.</p>
