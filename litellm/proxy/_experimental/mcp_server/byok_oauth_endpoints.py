...
<title>Connect {server_name} &mdash; RAW</title>
<style>
...
<div class="modal">
  ...
  <div id="s1" class="step show">
    ...
    <div class="logos">
      <img src="/ui/assets/logos/raw_icon.png" class="logo-img" alt="RAW">
      <span class="logo-arrow">&#8594;</span>
      <div class="logo logo-s">{server_initial}</div>
    </div>

    <h2 class="step-title">Connect {server_name} MCP</h2>
    <p class="step-subtitle">RAW needs access to {server_name} to complete your request.</p>
    ...
    <div class="info-box">
      ...
      <div>
        <h4>How it works</h4>
        <p>RAW acts as a secure bridge. Your requests are routed through our MCP client directly to {server_name}&rsquo;s API.</p>
      </div>
    </div>
